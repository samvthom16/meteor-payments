...
<!-- stripe payment form -->
<form method="POST" data-locale="<?php _e( $lang );?>" data-msg="<?php _e( $this->get_label( 'thank_you', $lang ) );?>" data-behaviour='meteor-stripe-form meteor-slides' data-url="<?php _e( admin_url('admin-ajax.php')."?action=meteor_process_form" );?>">
